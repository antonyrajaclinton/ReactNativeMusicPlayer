            ...
            <View style={{ backgroundColor: getPaperTheme.colors.background, height: '100%' }}>
                <ScrollView>
                    ...
                    <View style={{ ...styles.centerTitle, marginTop: 10 }} >
                        <Text variant='headlineSmall' style={{ fontWeight: 'bold', color: getPaperTheme.colors.primary }}>RN Music Player</Text>
                    </View>
                    <View style={{ ...styles.centerTitle, marginTop: 10 }} >
                    ...
                    <View style={{ paddingLeft: 20, paddingRight: 20, marginTop: 30 }}>
                        ...
                        <View style={{ marginTop: 50, marginBottom: 80 }} >
                            <Button icon="cloud-off-outline" textColor='#fff' buttonColor={getPaperTheme.colors.outline} mode="contained" style={{ marginTop: 5 }} onPress={() => console.log('Pressed')}>
                                Offline Music
                            </Button>
                        </View>
